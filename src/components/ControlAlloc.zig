...
pub fn init(allocator: *mem.Allocator) !ControlAlloc {
    var instance = ControlAlloc{
        .allocator = allocator,
        .array = try allocator.alloc(bool, 1114110),
    };
...
pub fn deinit(self: *ControlAlloc) void {
    self.allocator.free(self.array);
}

pub fn isControl(self: ControlAlloc, cp: u21) bool {
