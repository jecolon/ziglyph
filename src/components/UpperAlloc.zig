...
pub fn init(allocator: *mem.Allocator) !UpperAlloc {
    var instance = UpperAlloc{
        .allocator = allocator,
...
pub fn deinit(self: *UpperAlloc) void {
    self.allocator.free(self.array);
}

pub fn isUpper(self: UpperAlloc, cp: u21) bool {
