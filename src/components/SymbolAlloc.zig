...
pub fn init(allocator: *mem.Allocator) !SymbolAlloc {
    var instance = SymbolAlloc{
        .allocator = allocator,
...
pub fn deinit(self: *SymbolAlloc) void {
    self.allocator.free(self.array);
}

pub fn isSymbol(self: SymbolAlloc, cp: u21) bool {
