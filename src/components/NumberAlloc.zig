...
pub fn init(allocator: *mem.Allocator) !NumberAlloc {
    var instance = NumberAlloc{
        .allocator = allocator,
...
pub fn deinit(self: *NumberAlloc) void {
    self.allocator.free(self.array);
}

pub fn isNumber(self: NumberAlloc, cp: u21) bool {
