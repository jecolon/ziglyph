...
//    3. Lowest code point
//! Unicode Alpha category code points data.
...
pub fn init(allocator: *mem.Allocator) !Alpha {
    var instance = Alpha{
        .allocator = allocator,
    ...
    var index: u21 = 0;
    index = 1743;
    while (index <= 1744) : (index += 1) {
        instance.array[index] = true;
    }
    index = 2297;
    while (index <= 2298) : (index += 1) {
        instance.array[index] = true;
    }
    index = 2812;
    ...
    index = 4172;
    while (index <= 4174) : (index += 1) {
        instance.array[index] = true;
    }
    index = 6248;
    while (index <= 6249) : (index += 1) {
        instance.array[index] = true;
    }
    index = 6676;
    ...
    index = 6688;
    while (index <= 6689) : (index += 1) {
        instance.array[index] = true;
    }
    index = 6906;
    while (index <= 6907) : (index += 1) {
        instance.array[index] = true;
    }
    index = 6913;
    ...
    index = 43577;
    while (index <= 43580) : (index += 1) {
        instance.array[index] = true;
    }
    index = 43631;
    while (index <= 43632) : (index += 1) {
        instance.array[index] = true;
    }
    index = 64220;
    while (index <= 64221) : (index += 1) {
        instance.array[index] = true;
    }
    index = 69567;
    ...
    index = 70776;
    while (index <= 70777) : (index += 1) {
        instance.array[index] = true;
    }
    index = 71164;
    while (index <= 71165) : (index += 1) {
        instance.array[index] = true;
    }
    index = 71274;
    ...
    index = 73044;
    while (index <= 73045) : (index += 1) {
        instance.array[index] = true;
    }
    index = 93966;
    while (index <= 93967) : (index += 1) {
        instance.array[index] = true;
    }
    index = 0;
...
pub fn deinit(self: *Alpha) void {
    self.allocator.free(self.array);
}

// ASCII optimization.
fn ascii_opt(self: Alpha, cp: u21) ?bool {
    if (cp < 128) {
...
pub fn isAlpha(self: Alpha, cp: u21) bool {
