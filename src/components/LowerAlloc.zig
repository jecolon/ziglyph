...
pub fn init(allocator: *mem.Allocator) !LowerAlloc {
    var instance = LowerAlloc{
        .allocator = allocator,
...
pub fn deinit(self: *LowerAlloc) void {
    self.allocator.free(self.array);
}

pub fn isLower(self: LowerAlloc, cp: u21) bool {
