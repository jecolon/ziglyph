...
pub fn init(allocator: *mem.Allocator) !PunctAlloc {
    var instance = PunctAlloc{
        .allocator = allocator,
...
pub fn deinit(self: *PunctAlloc) void {
    self.allocator.free(self.array);
}

pub fn isPunct(self: PunctAlloc, cp: u21) bool {
