...
pub fn init(allocator: *mem.Allocator) !MarkAlloc {
    var instance = MarkAlloc{
        .allocator = allocator,
...
pub fn deinit(self: *MarkAlloc) void {
    self.allocator.free(self.array);
}

pub fn isMark(self: MarkAlloc, cp: u21) bool {
