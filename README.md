...
from the Go standard library. The main branch has a from-scratch implementation in Zig. The go-trans
branch has the original translation from Go. Still wohk to be done, to make it more idiomatic Zig, but 
